   ...
   <div class="container-chat clearfix">
        ...
        <li @click.prevent="selectUser(user.id)" class="clearfix" v-for="user in userList" :key="user.id">
          ...
          <div class="about">
            ...
            <div class="status" style="color: #fff">
              <div v-if="onlineUser(user.id) || online.id==user.id"><i class="fa fa-circle online"></i>online</div>
              <div v-else><i class="fa fa-circle"></i>offline</div>
    ...
    <div class="chat">
      <div class="chat-header clearfix">
        ...
        <ul class="nav nav-tabs">
          <li class="nav-item dropdown">
            <a href="" data-toggle="dropdown" class="nav-link dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">...</a>
            <div class="dropdown-menu">
              <a href="" class="dropdown-item" @click.prevent="deleteAllMessage">Delete Conversation</a>
            </div>
          </li>
        </ul>
      </div> <!-- end chat-header -->
      ...
      <div class="chat-history" v-chat-scroll>
        <ul>
          <li v-for="message in userMessage.messages" class="clearfix" :key="message.id">
            <div class="message-data align-right">
              ...
              <ul class="nav nav-tabs">
                <li class="nav-item dropdown">
                  <a href="" data-toggle="dropdown" class="nav-link dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">...</a>
                  <div class="dropdown-menu">
                    <a href="" class="dropdown-item" @click.prevent="deleteSingleMessage(message.id)">Delete</a>
                  </div>
                </li>
              </ul>
      ...
      <div class="chat-message clearfix">
        ...
        <textarea v-if="userMessage.user" @keydown.enter="sendMessage" v-model="message" name="message-to-send" id="message-to-send" placeholder ="Type your message" rows="3"></textarea>

        <textarea v-else disabled name="message-to-send" id="message-to-send" rows="3"></textarea>
